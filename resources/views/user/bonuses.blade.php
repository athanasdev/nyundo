...
<head>
    ...
    <meta property="og:url" content="https://inexfx.com/bonuses">
...
<body style="overflow-x: hidden">
    ...
    <div class="header fixed-top d-flex justify-content-center align-items-center" style="background: #1e2730;">
        ...
        <h3 style="font-size:16px!important;font-weight:600">Bonuses</h3>
    </div>
    <div class="pt-45 pb-16">
        <div class="tf-container" style="padding:20px 20px 70px 20px">
            <span style="font-size: 18px;font-weight:700">Direct Invitation Bonus</span>
            <div class="d-row align-center justify-center">
                <img src="https://inexfx.com/bonus-1.png" alt="" style="height: 200px;width:auto">
            </div>
            <div class="d-row justify-evenly mb-3">
                <div class="d-col align-center top-gift-card">
                    <span style="font-size: 20px;font-weight:800;color:#fff">0</span>
                    <span style="font-size: 14px;margin-top:6px;color:#fff">Active Users</span>
                    <div class="text-center" style="column-gap: 4px;margin-top:4px;font-size:12px">
                ...
                <div class="d-col align-center top-gift-card">
                    ...
                    <span style="font-size: 14px;margin-top:6px;color:#fff">My Rewards</span>
                    <div class="text-center" style="column-gap: 4px;margin-top:4px;font-size:12px">
                        <i class="iconsax" icon-name="info-circle"></i>
                        Accumulated Rewards from Previous Activities
                    </div>
                </div>
            </div>
            <div class="">
                <span style="font-size: 16px;font-weight:700">Tier 1 Rewards</span>
                <div class="d-col" style="margin-top: 6px">
                    <div class="d-row justify-space w-100" style="border:1px solid #7e808830;padding:6px">
                        <span class="w-3" style="font-size: 14px;">Members</span>
                        <span class="w-3" style="font-size: 14px;">Rewards</span>
                        <span class="w-3" style="font-size: 14px;">Extra</span>
                    </div>
                    <div class="d-row justify-space w-100"
                        style="padding: 6px;color:#fff;font-size:14px;border:1px solid #7e808830">
                        <span class="w-3">10</span>
                        <span class="w-3">15 USDT</span>
                        <span class="w-3">-</span>
                    </div>
                </div>
            </div>
            <div class="" style="margin-top:20px">
                <span style="font-size: 16px;font-weight:700">Tier 2 Rewards</span>
                <div class="d-col" style="margin-top: 6px">
                    <div class="d-row justify-space w-100" style="border:1px solid #7e808830;padding:6px">
                        <span class="w-3" style="font-size: 14px;">Members</span>
                        <span class="w-3" style="font-size: 14px;">Rewards</span>
                    ...
                    <div class="d-row justify-space w-100"
                        ...
                        <span class="w-3">35 USDT</span>
                        <span class="w-3">Monthly Salary</span>
                    </div>
                    <div class="d-row justify-space w-100"
                        style="padding: 6px;color:#fff;font-size:14px;border:1px solid #7e808830">
                        <span class="w-3">60</span>
                        <span class="w-3">50 USDT</span>
                        <span class="w-3">Monthly Salary</span>
                    </div>
                </div>
            </div>
            ...
            <div class="" style="margin-top:20px">
                <span style="font-size: 16px;font-weight:700">Tier 3 Rewards</span>
                <div class="d-col" style="margin-top: 6px">
                    <div class="d-row justify-space w-100" style="border:1px solid #7e808830;padding:6px">
                        <span class="w-3" style="font-size: 14px;">Members</span>
                        <span class="w-3" style="font-size: 14px;">Rewards</span>
                    ...
                    <div class="d-row justify-space w-100"
                        style="padding: 6px;color:#fff;font-size:14px;border:1px solid #7e808830">
                        <span class="w-3">100</span>
                        <span class="w-3">70 USDT</span>
                        <span class="w-3">Weekly Salary</span>
                    </div>
                    <div class="d-row justify-space w-100"
                        style="padding: 6px;color:#fff;font-size:14px;border:1px solid #7e808830">
                        <span class="w-3">150</span>
                        <span class="w-3">100 USDT</span>
                        <span class="w-3">Weekly Salary</span>
                    </div>
                    <div class="d-row justify-space w-100"
                        style="padding: 6px;color:#fff;font-size:14px;border:1px solid #7e808830">
                        <span class="w-3">250</span>
                        <span class="w-3">160 USDT</span>
                        <span class="w-3">Weekly Salary</span>
                    </div>
                    <div class="d-row justify-space w-100"
                        style="padding: 6px;color:#fff;font-size:14px;border:1px solid #7e808830">
                        <span class="w-3">400</span>
                        <span class="w-3">300 USDT</span>
                        <span class="w-3">Weekly Salary</span>
                    </div>
                    <div class="d-row justify-space w-100"
                        style="padding: 6px;color:#fff;font-size:14px;border:1px solid #7e808830">
                        <span class="w-3">100</span>
                        <span class="w-3">2000 USDT</span>
                        <span class="w-3">Weekly Salary</span>
                    </div>
                </div>
            </div>
