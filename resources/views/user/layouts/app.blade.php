...
<head>
    ...
    <style>
        * {
        ...
        .container-main {
            /* Renamed from .container to avoid conflict if bootstrap is used */
            max-width: 1400px;
            margin: 0 auto;
            padding: 16px;
            padding-bottom: 90px;
            ...
            <div class="user-balance">
                ...
                <div class="balance-item">
                    <form method="POST" action="{{ route('user.logout') }}">
                        @csrf
                        <button type="submit" class="balance-amount" id="todayPnLDisplay"
                            style="background:none; border:none; padding:0; cursor:pointer;">
                            <i class="fas fa-sign-out-alt" style="color:#e74c3c; font-size:1.2em;"></i>
                        </button>
                    </form>
                    <div class="balance-label">Sign Out</div>
                </div>
