                ...
                <div class="timing-info">
                    <div class="timing-item">
                        ...
                        <div class="timing-value" id="signalOpenTime">
                            {{-- FIX #1: Correctly format the Carbon object from the model --}}
                            {{ isset($activeGameSetting) ? $activeGameSetting->start_time->format('M d, Y H:i') : 'N/A' }}
                        </div>
                    </div>
                    <div class="timing-item">
                        ...
                        <div class="timing-value" id="signalCloseTime">
                            {{-- FIX #1: Correctly format the Carbon object from the model --}}
                            {{ isset($activeGameSetting) ? $activeGameSetting->end_time->format('M d, Y H:i') : 'N/A' }}
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        const signalData = {
            // FIX #2: Use toISOString() to pass a universal, timezone-aware UTC string to JavaScript.
