...
@push('styles')
    <style>
        .setup-panel-card {
            /* Specific card class for this page */
            max-width: 600px;
            margin-left: auto;
            margin-right: auto;
            margin-top: 20px;
            /* Or adjust as per your layout's main content padding */
        }
        ...
        .alert-info {
            /* For informational messages like "Please set up..." */
            color: #f0b90b;
            /* Using accent color for info */
        ...
        .invalid-feedback {
            ...
            margin-top: .25rem;
            font-size: .875em;
            /* Bootstrap's default is 0.875em */
            color: #f6465d;
        }
            ...
            <form method="POST" action="{{ route('withdraw.setup.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="withdrawal_pin" name="withdrawal_pin"
                        ...
                        placeholder="Enter a 4-6 digit PIN" required minlength="4" maxlength="6" pattern="\d*">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="withdrawal_pin_confirmation" name="withdrawal_pin_confirmation"
                        class="form-control" {{-- No need for @error here, 'confirmed' rule handles it on withdrawal_pin --}} placeholder="Re-enter your PIN" required>
