...
<head>
    ...
    <meta name="description"
        content="Explore Nyundo tools, features, and services designed to help you trade smarter and grow your investments with confidence.">
    <meta name="keywords"
    ...
    <meta property="og:url" content="https://inexfx.com/my-team">
...
<body style="overflow-x: hidden">
    ...
    <style>
        ...
        .vips-class {
            border: 1px solid #8d98a650;
            border-radius: 10px;
            margin-top: 20px;
        }

        .vip-card {
            border-bottom: 1px solid #7e808820;
            padding: 15px;
        }
    </style>
    ...
    <div class="pt-45" style="padding-bottom:70px">
        ...
        <div class="" style="padding: 0 20px">
            <div class="vips-class">
                <div class="vip-card">
                    <div class="d-row mb-3">
                        <span style="font-size: 16px;font-weight:600;margin-right:10px;color:aliceblue">Level 1</span>
                ...
                <div class="vip-card">
                    <div class="d-row mb-3">
                        <span style="font-size: 16px;font-weight:600;margin-right:10px;color:aliceblue">Level 2</span>
                    </div>
                    <div class="d-row justify-space">
                        <div class="d-col w-50">
                            <span style="font-size:14px;margin-bottom:4px">Members</span>
                ...
                <div class="vip-card">
                    <div class="d-row mb-3">
                        <span style="font-size: 16px;font-weight:600;margin-right:10px;color:aliceblue">Level 3</span>
                    </div>
                    <div class="d-row justify-space">
                        <div class="d-col w-50">
                            <span style="font-size:14px;margin-bottom:4px">Members</span>
                ...
                <div class="vip-card">
                    <div class="d-row mb-3">
                        <span style="font-size: 16px;font-weight:600;margin-right:10px;color:aliceblue">Total</span>
                    </div>
                    <div class="d-row justify-space">
                        <div class="d-col w-50">
